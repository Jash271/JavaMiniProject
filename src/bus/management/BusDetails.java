...
@NamedQueries({
    ...
    @NamedQuery(name = "BusDetails.findByBusMove", query = "SELECT b FROM BusDetails b WHERE b.busMove = :busMove"),
...
public class BusDetails implements Serializable {
    ...
    public BusDetails(Integer id, String busNo, String busMove, String busSource, String busDest, Date departDate, String departTime, String price, String totalSeat) {
        this.id = id;
        this.busNo = busNo;
